...
Dans le menu qui s'ouvre, taper le numéro correspondant à Install/Update Full ROM Firmware et valider.  
Taper le numéro correspondant à Install/Update Full ROM Firmware (UEFI) (c'est généralement le choix 1 ou 2) et valider avec Entrée.
...
Le problème est qu'ALSA (le système audio Linux) ne trouve pas le bon dossier de réglages parce que le nom a une micro-différence (sof-glkrt5682ma au lieu de sof-glk-rt5682).
